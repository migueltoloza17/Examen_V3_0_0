...
{
    public class ManejadorAvion : IMedioTransporte
    {
        public int iVelocidadEntrega = 600;
        ...
        public void MostrarEstatusPedido(string _cMensajeUno, string _cOrigen, string _cMensajeDos, string _cDestino, decimal __dCosto, string _cPaqueteria)
        {
            Console.WriteLine("Tu paquete {0} de {1} y {2} a {3} y tuvo un costo de ${4}(cualquier reclamación con {5}).", _cMensajeUno, _cOrigen, _cMensajeDos, _cDestino, __dCosto.ToString(), _cPaqueteria);
        }
    }
}
